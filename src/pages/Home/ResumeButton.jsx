			...
			<div className="relative flex items-center justify-center gap-2 px-3 py-1 text-sm text-white bg-blue-400 rounded-md sm:text-xl">
				...
				<AnimatePresence>
					{toggleChooseVer && (
						...
						>
							<a
								href="https://drive.google.com/file/d/1RnNMUIpTnFH3DyvaoHtKI13VQ19yFKaL/view?usp=drive_link"
								target="_blank"
							...
							<a
								href="https://drive.google.com/file/d/1Tj52nERaSU8VJslqa7aD4lV-BmbnNx4T/view?usp=drive_link"
								target="_blank"
